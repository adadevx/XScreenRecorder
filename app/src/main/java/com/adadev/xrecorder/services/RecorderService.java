...
package com.adadev.xrecorder.services;
...
import com.adadev.xrecorder.BuildConfig;
import com.adadev.xrecorder.Const;
import com.adadev.xrecorder.DemoMode.DemoModeController;
import com.adadev.xrecorder.R;
import com.adadev.xrecorder.gesture.ShakeEventManager;
import com.adadev.xrecorder.ui.EditVideoActivity;
import com.adadev.xrecorder.ui.MainActivity;
...
public class RecorderService extends Service implements ShakeEventManager.ShakeListener {
    ...
    private void stopRecording() {
        ...
        if (showTouches) {
            ...
            TouchIntent.setAction("com.adadev.xrecorder.DISABLETOUCH");
    ...
    private void resumeScreenRecording() {
        ...
        if (showTouches) {
            Intent TouchIntent = new Intent();
            TouchIntent.setAction("com.adadev.xrecorder.SHOWTOUCH");
            TouchIntent.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
            sendBroadcast(TouchIntent);
